...
// move konstruktorius
Stud::Stud(Stud &&s) : Zmogus(move(s)), egzaminas(s.egzaminas), nd{move(s.nd)}, galutinisSuVidurkiu(move(s.galutinisSuVidurkiu)), galutinisSuMediana(move(s.galutinisSuMediana)){ s.clear();}
